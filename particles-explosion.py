...
while True:
    ...
    for _ in range(20):
        ...
        particles.append([[mx, my], [random.randint(-100, 100)/10, random.randint(-100, 100)/10], random.randint(
            4, 10), ((random.randint(10, 25)), (random.randint(10, 100)), (random.randint(1, 255)))])
